...
CREATE TABLE admins(id serial, nick VARCHAR(64) UNIQUE NOT NULL, first_name VARCHAR(64) NOT NULL, last_name VARCHAR(64) NOT NULL, email VARCHAR(64) UNIQUE NOT NULL, is_blocked INTEGER NOT NULL, pass VARCHAR(64) NOT NULL);
